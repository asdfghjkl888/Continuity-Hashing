...
static int global_cpu_speed_mhz = 2400; //2399.941   //欣欣：相比level新增的
static int global_write_latency_ns = 150;  //欣欣：相比level新增的

void emulate_latency_ns(int ns);   //欣欣：相比level新增的
